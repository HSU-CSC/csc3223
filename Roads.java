 ...
 */
public class Roads extends Application {
   ...
   // private Graph graph;
    ...
    public void fileChoiceScreen()
    {
        ...
        next.setOnAction(event -> {
            ...
            catch(IOException ex)
            {
                ...
                //error.setText("Error! File cannot be found! Please Try Again.");
    ...
    private void populateGraph(String fileName)throws IOException
    {
        ...
        while(in.hasNextLine())
        {
            ...
            //to do, check formating of line and add contents to the Graph
        }
    }
